...
var ASM_CONSTS = {
  1455264: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 1455325: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 1455389: function() {return Module.webglContextAttributes.powerPreference;},  
 1455447: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 1455502: function($0) {performance.now = function() { return $0; };},  
 1455550: function($0) {performance.now = function() { return $0; };},  
 1455598: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function preprocess_c_code(code, defs = {}) {
      ...
      defs['line'] = () => { // replace #line macro with empty line.
        return "";
      };
      ...
      for(; i < len; ++i) {
        ...
        case 'line': break; // ignore GLSL debugging directive.
        default:
